        ...
        <div class="header-bottom hidden-xs hidden-sm">
          <div class="container container-240">
            <div class="conBtmRgHdr">
              <div class="btmRgHdr">
                @if ($promoviewhome==1)
                <a class="goSec" href="#secPromo">
                  <div>
                    PROMO
                  </div>
                </a>
                @endif
                <a class="goSec" href="#secBest">
                  <div>
                    BUKU TERLARIS
                  </div>
                </a>
                <a class="goSec" href="#secNew">
                  <div>
                    BUKU TERBARU
                  </div>
                </a>
                <a class="goSec" href="#secRev">
                  <div>
                    REVIEW BUKU
                  </div>
                </a>
                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-6 col-xs-12">
                      <div class="conFooter1">
                        <img src="{{$getBaseUrl}}img/aqwam_putih.png" alt="" style="max-width:200px!important" class="img-reponsive" >
