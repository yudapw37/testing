...
<div class="main-content space1">
            <div class="container container-240 mt-5">
                <!-- <form name="checkout" class="mt-5" method="post" class="co"> -->
                    <div class="cart-box-container-ver2">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="co-left bd-7" style="padding: 0px 20px!important;">
                                    <div class="cmt-title text-center abs">
                                        <h1 class="page-title v1">Detail Pengiriman</h1>
                                    </div>
                                    <div class="midBoxAlamat table-responsive">
                                      <div style="font-size:13px; padding:20px;">
                                        ...
                                        <div style="padding: 10px 0;text-align:right">
                                          <button type="button" style="width:125px" class="btnB btn-gradient" data-toggle="modal" data-target="#staticBackdrop">
                                            Tambah Alamat
                                          </button>
                                            ...
                                            <div class="modal-dialog modal-md">
                                              <div class="modal-content" style="border-radius:10px;border:2px solid #ccc7c7">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <button type="button" onclick="isialamat()" class="btn btn-success">Pilih</button>
                                          ...
                                          <button id="myButton" type="button" style="width:125px" class="btnB btn-gradient" data-toggle="modal">
                                            Pilih Alamat Lain
                                          </button>
                                        </div>
                                          <!-- Modal -->
                                ...
                                <div class="cart-total bd-7 mb-2">
                                    ...
                                    <div style="margin:0 15px;">
                                      ...
                                      <table class="w-100 mt-1">
                                        <tr>
                                          <td>
                                            <select onclick="cekManual(this)" id="cEkspds" style="float:left" class="form-control" name="">

                                            </select>
                                          </td>
                                          <!-- <td id="spinner" class="d-none">
                                    ...
                                    <div class="cart-total-bottom v2">
                                        <a id='BtnOrder' href="#" onclick="addinv()" class="btn-gradient btn-checkout btn-co-order disabled" >Order Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
