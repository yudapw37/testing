...
<head>
    ...
    <meta name="keywords" content="book, buku, islam, buku islam, aqwam, solo, storeaqwam" />
...
<body onload="onLoad('{{$pathhf}}', '{{$pathcs}}')">
        ...
        <div class="menu-push">
            ...
            <!-- <form role="search" method="get" id="searchform" class="searchform" action="/search">
                ...
                <div>
                    ...
                    <button type="submit" id="search"><i class="ion-ios-search-strong"></i></button>
               ...
               <li class="level1 active dropdown">
                ...
                <li class="level1 active dropdown"><a href="#">Categories</a>
                    ...
                    <ul class="menu-level1 js-open-menu" id="categoriesmenu">
                        ...
                        <li class="level2"><a href="/search?id=2" title="">Penerbit</a></li>
                        <li class="level2"><a href="/search?id=3" title="">Promo</a></li>
                    </ul>
                                ...
                                <div class="topbar-right">
                                    ...
                                    <div class="element element-leaguage">
                                        ...
                                        <a id="label2" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" aria-label="label2">
                                            ...
                                            <img style="width:19px;" src="img/icon-l.png" alt="">
                                            @if ($nama == 'null')
                    ...
                    <div class="row flex">
                            ...
                            <div class="col-lg-3  col-md-3 col-sm-5 col-xs-4 v-center header-sub">
                                ...
                                <div class="right-panel">
                                    ...
                                    @if ($nama != 'null')
                                    <a id="akunScroll" href="/akun" style="display: none;">
                                      <img style="width: 25px;" src="img/icon-l.png" alt="">
                                    </a>
                                    @else
                                    <a id="akunScroll" href="/login" style="display: none;">
                                      <img style="width: 25px;" src="img/icon-l.png" alt="">
                                    </a>
                                    @endif
                                    ...
                                    <div class="hidden-lg hidden-md" style="margin-right:10px;">
                                      ...
                                      <a id="label2" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" aria-label="label2">
                                          @if ($nama == 'null')
                                          <a href="/login"><img style="width:19px;" src="{{$getBaseUrl}}img/icon-l.png" alt=""></a>
                                          ...
                                          @else
                                              <!-- <a href="/akun">{{$nama}}</a> -->
                                              <div class="dropdownLgn">
                                                <a href="#" class=""><img style="width:19px;" src="{{$getBaseUrl}}img/icon-l.png" alt=""></a>
                                                <div class="dropdown-contentLgn text-center">
