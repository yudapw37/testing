...
@section('body')
      ...
      <div class="text-center" style="">
        ...
        <div id="cap2" class="container mb-5" style="width:100%">
          <center>
            <a class="btn btn-danger mx-2 mt-1" href="/akun">Kembali</a>
            <input type="button" class="btn btn-success mx-2 mt-1" onclick="printDiv('capture')" value="Cetak Invoice PDF" />
            <button id="download" class="btn btn-success mx-2 mt-1">Cetak Invoice PNG</button>
          </center>
        </div>
      </div>
      ...
      <div style="overflow:auto">
        <div id="capture" style="width:1000px;transform: scale(0.85);padding:1.5em">
          ...
          <table class="table table-sm-responsive table-borderless mt-1">
            ...
            <tr>
              <td class="text-bold" colspan="5">Diskon Kode Unik</td>
              <td class="text-right">Rp. {{number_format($inv->diskonKodeUnik, 2,',','.')}}</td>
            </tr>
            <tr>
              ...
              <td class="text-bold"></td>
              <td class="text-bold"></td>
                          <td class="text-bold text-right">Rp. {{number_format($inv->total_harga + $inv->biaya_expedisi - $inv->totalDiskon - $inv->diskonKodeUnik, 2,',','.')}}</td>
            </tr>
          </tbody></table>
          ...
          <table class="table table-sm-responsive table-borderless">
            <tbody><tr>
              ...
              <p>  </p>
              <p> - BCA 7850875230 an Ismail Huda </p>
              <p> - BNI 1122644123 an Ismail Huda </p>
              <p> - Mandiri 1380018169503 an Ismail Huda </p>
              <p> - BRI 033401087104503 an Ismail Huda </p>
