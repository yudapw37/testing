        ...
        $getBaseUrl = 'http://storeaqwam.cemaraitsalatiga.com/';
            ...
            if ($request->session()->has('idUser')){
                ...
                if($buku){
                    ...
                    'newdisc'=>$newdisc, 'discrand'=>$discrand,'discrandrupiah'=>$discrandrupiah,'cekpenerima'=>$cekpenerima]);
               }
                }else{
        ...
        if ($request->session()->has('idUser')){
            if($request->session()->get('token')=='4qw4m5t0r3'){
                ...
                if($cekstock==1){
                    ...
                    $inv=$this->createinv($username,$diskon, $idorder,$kodeAdminTrx,$typeTransaksi,$code_customer,$expedisi,$biaya_expedisi
