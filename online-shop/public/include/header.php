            ...
            <div class="row flex lr2">
                <div class="col-lg-3 widget-verticalmenu">
                    <div class="navbar-vertical">
                        <button class="navbar-toggles"><span>AKUN DETAIL</span></button>
                    </div>
                    <div class="vertical-wrapper">
                        <ul class="vertical-group">
                            <li class="vertical-item level1 mega-parent"><a href="#">Invoice</a></li>
                            <li class="vertical-item level1 mega-parent"><a href="#">Wishlist</a></li>
                            <li class="vertical-item level1 mega-parent"><a href="#">Order</a></li>
                            <li class="vertical-item level1 mega-parent"><a href="#">Address</a></li>
                        </ul>
                    </div>
                </div>
