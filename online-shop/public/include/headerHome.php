        ...
        <div class="container container-240">
          <div class="row flex">
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 v-center header-logo">
                    <a href="#"><img src="img/icon.png" alt="" class="img-reponsive" style="height:40px!important"></a>
                </div>
            ...
            <div class="row flex lr2">
                <div class="col-lg-3 widget-verticalmenu">
                    ...
                    <div id="verHide" class="vertical-wrapper">
                        <ul class="vertical-group d-none">
                        ...
                        <nav class="main-menu">
                            <div class="collapse navbar-collapse" id="myNavbar">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="level1"><a href="#">Buku Terbaru<span class="h-ribbon h-pos e-red">New</span></a></li>
