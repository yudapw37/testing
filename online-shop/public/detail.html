            ...
            <div class="container container-240">
                <div class="row flex">
                    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 v-center header-logo">
                        <a href="#"><img src="img/icon.png" alt="" class="img-reponsive"></a>
                    </div>
                    <div class="col-lg-7 col-md-7 v-center header-search hidden-xs hidden-sm">
                            ...
                            <ul class="list-product-search hidden-xs hidden-sm">
                                <li>
                                    <a class="flex align-center" href="">
                                        ...
                                        <h3 class="product-title">Buku 100 Ulama Nusantara</h3>
                                    </a>
                                </li>
                                <li>
                                    <a class="flex align-center" href="">
                                        ...
                                        <h3 class="product-title">Buku Golden Ways to Jannah</h3>
                                    </a>
                                <li>
                                    <a class="flex align-center" href="">
                                        <div class="product-img">
                                        ...
                                        <h3 class="product-title">Buku Seni Interaksi Rasulullah</h3>
                                    </a>
                                </li>
                                <li>
                                    <a class="flex align-center" href="">
                                        ...
                                        <h3 class="product-title">Buku Muhammad Al Fatih </h3>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="tags">
                            ...
                            <a href="#">Buku Banjir Darah</a>
                            <a href="#">Islamic Parenting</a>
                            <a href="#">Fikih Empat Mahzab</a>
                            <a href="#">Buku Golden Ways</a>
                        </div>
                    </div>
                        ...
                        <div class="right-panel">
                            <div class="header-sub-element hidden-xs hidden-sm">
                                ...
                                <div class="sub-right">
                                    ...
                                    <div class="phone">085771224422 </div>
                                </div>
                            </div>
                                    ...
                                    <div class="dropdown-menu dropdown-cart">
                                        <ul class="mini-products-list">
                                            ...
                                            <li class="item-cart">
                                                ...
                                                <div class="product-details">
                                                    <div class="inner-left">
                                                        <div class="product-name"><a href="#">Buku Golden Ways to Jannah </a></div>
                                                        <div class="product-price">
                                                            Rp. 88.000 <span>( x2)</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <a href="#" class="e-del"><i class="ion-ios-close-empty"></i></a>
                                        ...
                                        <div class="bottom-cart">
                                            <div class="cart-price">
                                                <span>Subtotal</span>
                                                <span class="price-total">Rp. 276.000</span>
                                            </div>
                       ...
                       <div class="row flex lr2">
                            <div class="col-lg-3 widget-verticalmenu">
                                <div class="navbar-vertical">
                                    <button class="navbar-toggles navbar-drop js-vertical-menu"><span>Categories</span></button>
                                </div>
                                <div class="vertical-wrapper">
                                    <ul class="vertical-group">
                                        <li class="vertical-item level1 mega-parent"><a href="#">Buku Baru</a></li>
                                        <li class="vertical-item level1 mega-parent"><a href="#">Promo Terbaru <span class="h-ribbon e-red mg-l3">Hot</span></a></li>
                                        <li class="vertical-item level1 mega-parent"><a href="#">Buku Parenting</a></li>
                                        <li class="vertical-item level1 mega-parent"><a href="#">Al-Quran</a></li>
                                        <li class="vertical-item level1 mega-parent"><a href="#">Buku Anak</a></li>
                                        <li class="vertical-item level1 mega-parent"><a href="#">Buku Kisah Hikmah</a></li>
                                        <li class="vertical-item level1 mega-parent"><a href="#">Buku Motivasi</a></li>
                                    ...
                                    <nav class="main-menu flex align-center">
                                       ...
                                       <div class="collapse navbar-collapse" id="myNavbar">
                                            <ul class="nav navbar-nav js-menubar">
                                                ...
                                                <li class="level1"><a href="#"><img src="img/icon-diamond.png" alt="">Promo Bulan Ini</a></li>
                                                <li class="level1"><a href="#">Buku Terbaru<span class="h-ribbon h-pos e-skyblue">New</span></a></li>
                                                <li class="level1"><a href="#">Buku Terlaris</a></li>
                                            </ul>
                                        </div>
                                    </nav>
                        ...
                        <div class="flex product-img-slide">
                            ...
                            <div class="product-images">
                                <div class="main-img js-product-slider">
                                    <a href="#" class="hover-images effect"><img src="img/single/1.jpeg" alt="photo" class="img-reponsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/single/2.jpeg" alt="photo" class="img-reponsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/single/3.jpeg" alt="photo" class="img-reponsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/single/1.jpeg" alt="photo" class="img-reponsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/single/2.jpeg" alt="photo" class="img-reponsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/single/3.jpeg" alt="photo" class="img-reponsive"></a>
                                </div>
                            ...
                            <div class="multiple-img-list-ver2 js-click-product">
                                <div class="product-col">
                                    <div class="img active">
                                        <img src="img/single/1.jpeg" alt="photo" class="img-reponsive">
                                    </div>
                                </div>
                                <div class="product-col">
                                    <div class="img">
                                        <img src="img/single/2.jpeg" alt="images" class="img-responsive">
                                    </div>
                                </div>
                                <div class="product-col">
                                    <div class="img">
                                        <img src="img/single/3.jpeg" alt="images" class="img-responsive">
                                    </div>
                                </div>
                                <div class="product-col">
                                    <div class="img">
                                        <img src="img/single/1.jpeg" alt="images" class="img-responsive">
                                    </div>
                                </div>
                                <div class="product-col">
                                    <div class="img">
                        ...
                        <div class="single-flex">
                            <div class="single-product-info product-info product-grid-v2 s-50">
                                ...
                                <div class="short-desc">
                                    <p class="product-desc">Deskripsi Produk Buku akan berisi deskripsi banyak dan di ambil data dari database yang sudah tersimpan</p>
                                    <!-- <ul class="desc-list">
                    ...
                    <div id="desc" class="tab-pane fade in active">
                        <div class="entry-content">
                            ...
                            <div class="entry-inside">
                                ...
                                <div class="entry-element flex align-center">
                                    <div class="entry-img text-center">
                                        <img src="img/product/320_x_320_2.jpg" alt="">
                                    </div>
                                    <div class="entry-info">
                                        <h3>Deskripsi Produk Buku</h3>
                                        <p>It is a long established fact that a reader will be distracted by the readable content page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using</p>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            <div class="footer-block footer-about">
                                ...
                                <ul class="footer-block-content">
                                    <li class="address">
                                        <span>Jl. Menco Raya 112, Gonilan, Kartasura – Solo 57162</span>
                                    </li>
                                    <li class="phone">
                                        <span>(0271) 765 3000</span>
                                    </li>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                            <div class="footer-block">
                                <div class="footer-block-phone">
                                    ...
                                    <p class="phone-light">(0271) 765 3000</p>
                                </div>
                                <div class="footer-block-newsletter">
                                    <h3 class="footer-block-title">Subscription</h3>
                                    <p>Masukkan Email Anda untuk menerima pembaruan harian langsung ke kotak masuk Anda!</p>
                                    <form class="form_newsletter" action="#" method="post">
            ...
            <div class="f-bottom">
                <div class="container container-240">
                    <div class="row flex lr">
                        <div class="col-xs-6 f-copyright"><span>© 2020 Cemara IT Solution.</span></div>
